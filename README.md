...
![file-name-history-preview](https://github.com/user-attachments/assets/173da923-9761-4a7d-b08f-1f39d4722299)
...
File Name History is not yet available in the Community plugins section. Install using [BRAT](https://github.com/TfTHacker/obsidian42-brat) or manually:
...
1. Download the latest release from the [Releases page](https://github.com/davidvkimball/obsidian-file-name-history/releases) and navigate to your Obsidian vault's `.obsidian/plugins/` directory.
